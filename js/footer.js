...
(function($) {
  $.fn.openPopup = function( settings ) {
    ...
    elem.show();
    elem.find('.popup-contentf').addClass(settings.anim+'In');
  }
  ...
  $.fn.closePopup = function( settings ) {
    ...
    elem.find('.popup-contentf').removeClass(settings.anim+'In').addClass(settings.anim+'Out');
    
    setTimeout(function(){
        elem.hide();
        elem.find('.popup-contentf').removeClass(settings.anim+'Out')
      }, 500);
  }
